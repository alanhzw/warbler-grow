      ...
      <el-row type="flex" align="middle">
        <el-col :span="20">
          ...
          <el-form-item label="共享人：" prop="shareUserName" v-show="showName == 'shareMe'">
            <el-input v-model="form.shareUserName" suffix-icon="el" placeholder="请输入共享人" :clearable=true></el-input>
          </el-form-item>
          <el-form-item label="被共享人：" prop="beSharedUserName" v-show="showName == 'myShare'">
            <el-input v-model="form.beSharedUserName" suffix-icon="el" placeholder="请输入被共享人" :clearable=true></el-input>
          </el-form-item>
          ...
          <el-form-item label="表单名称：" prop="stepName" v-show="showName == 'formList'">
            <el-input v-model="form.stepName" suffix-icon="el" placeholder="" :clearable=true></el-input>
          </el-form-item>
