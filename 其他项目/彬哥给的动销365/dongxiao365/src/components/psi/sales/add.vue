        ...
        <el-form :inline="true" :model="order" ref="ruleForm" :rules="rules">
          <el-row>
            ...
            <el-form-item label="业务员：" style="padding-left: 13px;">
              <com-choose-user-in-line v-model="order.salesmanName"></com-choose-user-in-line>
            </el-form-item>
          </el-row>
          <el-row>
...
<script>
  ...
  export default {
    components: {
      ComChoseCommodity, ImageUpload, ComChooseCus, ComItemAutocmoplete, ComChooseUserInLine, ComWarehouse, ComItemUnit
    },
    data() {
      return {
        // 订单
