          ...
          <el-row>
            ...
            <el-col :span="16" class="text-right">
              <el-form :inline="true" class="form-compact" @submit.native.prevent>
                  <el-form-item>
                    <el-search v-model="page.keyword" @click="loadTableData" @keyup.enter="loadTableData" @keyup.enter.native="loadTableData" placeholder="请输入商品名称、编码、标签"></el-search>
                  </el-form-item>
                  <el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 修改--下拉菜单
      editOne(val) {
        this.$router.push({path: '/psi/base/commodity/edit', query: {id: val.id}})
      },
      // 删除--下拉菜单
      deleteOne(row) {
      ...
      /* 新增商品,页面跳转*/
      addCommodity() {
        this.$router.push({path: '/psi/base/commodity/add'});
      },
      // 查看商品详情
      info(row) {
