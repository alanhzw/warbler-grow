<template>
  <div>
    ...
    <div>
      ...
      <!--修改弹窗-->
      <el-dialog style="height:480px;" title="修改品牌" :visible.sync="dialog.editVisible" width="500px">
        <el-form :model="brandEdit" ref="editRuleForm" :rules="rules" label-width="100%">
          <el-form-item label="品牌名称：" prop="name">
...
<script>
  export default {
    ...
    methods: {
      ...
      /* 新增保存*/
      onSubmit(formName) {
        const customerInfo = Object.assign({}, this.brand)
        ...
        this.$refs[formName].validate((valid) => {
          if (!valid) {
            ...
            this.$http.post('/psi/item/brand/add', customerInfo, r => {
              this.$message({
                message: '添加成功！',
                type: 'success'
              });
