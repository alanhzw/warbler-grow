        ...
        <div class="panel-body">
          <el-form :rules="rules" ref="form" :model="form" label-position="top">
            ...
            <draggable v-model="components" class="dragArea" :options="dragAreaOptions">
              <div class="item" v-for="(element, index) in components" :key="index" @click="showProp($event,element)" v-if="element">
            ...
            <el-form-item>
              ...
              <el-button type="success" @click="$router.back()">取消</el-button>
            </el-form-item>
          </el-form>
          <el-row v-if="true">
            <el-col :span="11">
    ...
    data() {
      return {
        componentsKit: [
          ...
          {value: '', label: "文件上传", type: 'upload', required: false, description: '', placeholder: '', multiple: false, multipleLimit: 0, accept: ''},
      ...
      onSubmit() {
        this.$refs.form.validate((valid) => {
          if (valid) {
            ...
            this.$http.post('/form/tpl/add', postData);
          } else {
            return false;
          }
        });
