        ...
        <td>
          <table>
            ...
            <tr>
              ...
              <td>
                <div class="tag-list">
                  <el-tag  :key="tag.id" v-for="tag in customerInfo.tagList" :class="'tag tag-'+tag.labelColor">
                    {{tag.labelName}}
                  </el-tag>
                </div>
              </td>
      ...
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="收货地址" name="five">
          <el-table
            ...
            <el-table-column sortable prop="address" label="收货地址" width="120px"></el-table-column>
          </el-table>
        </el-tab-pane>
      </el-tabs>
    </el-row>
