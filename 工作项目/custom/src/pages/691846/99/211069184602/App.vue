...
* @FilePath:src\pages\691846\99\211069184602\App.vue
*/
<template>
  <div class='rePurchasePage'
    ...
    <div class='second-step'
      ...
      <exposure-goods :base-url='baseUrl'
                      :skus-list='skusList'
                      @go2Shop='gotoShopPage(baseInfo.shopId)'></exposure-goods>
    </div>
    ...
    <div class='fourth-step'
      ...
      <!-- 领取更多权益按钮 -->
      <div class='draw-more'
           @click='gotoShopPage(baseInfo.shopId)'>参与更多会员活动 &nbsp;&gt;&nbsp;&gt;
      </div>
    </div>
  ...
  <div class='activity-over'
    ...
    <div class='activity-over-btn'
         @click='gotoShopPage(baseInfo.shopId)'>进店逛逛
    </div>
  </div>
</template>
...
const step = ref(1);
const dataInfo = '1、您在近9个月内未购买正装商品且确认收货的订单<br/>2、订单时间以下单时间为准，取消、收货前退款的正装商品订单均不计算为满足活动条件的订单<br/>3、大促期不可使用(包括但不限于38、618、99、1111、1212等)';
// 跳转至规则页面
const go2Step1 = () => {
  step.value = 1;
};
