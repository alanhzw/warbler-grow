/** * @Description:caoshijie * @Date: 2021/10/11 * @Description: 【倩碧自营】
邀请有礼 * @FilePath:src\pages\1000376431\99\2110100037643103\App.vue */
<template>
  <div class="qianbiInvite">
    <!-- banner -->
    <img src="./assets/banner.jpg" class="background" />
    <!-- 活动规则按钮 -->
  ...
  cjwxRequest
    ...
    .then((res) => {
      if (res.data) {
        ...
        shareUrl.value = `${window.location.origin}/m/1000376431/99/2110100037643103/?helpUuid=${res.data.customerId}`;
...
const joinMember = () => {
  window.location.href = `https://shopmember.m.jd.com/shopcard/?venderId=1000376431&channel=401&returnUrl=${encodeURIComponent(
...
.invite-prize4 {
  background: url(./assets/prize4.jpg);
  background-size: 100%;
}
</style>
