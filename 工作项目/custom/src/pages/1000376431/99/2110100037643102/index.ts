 ...
 * @FilePath:src\pages\1000376431\99\2110100037643102\index.ts
 */
...
init({
  ...
  openCardLink: `https://shopmember.m.jd.com/shopcard/?venderId=1000376431&shopId=1000376431&channel=7036&returnUrl=${window.location.href}`,
})
  .then(({
    baseInfo,
    isOpenCard,
