<template>
  <div class="kv" v-cloak>
    <div class="collect" @click="getCoupon"></div>
    <div class="see-more" @click="goMore"></div>
  </div>
</template>
...
const getOpenStatus = () => {
  if (!isOpenCarded) {
    window.location.href = `https://shopmember.m.jd.com/shopcard?venderId=1000077433&shopId=1000077433&venderType=5&channel=7019&returnUrl=${window.location.href}`;
  }
};
// 领券
const getCoupon = () => {
