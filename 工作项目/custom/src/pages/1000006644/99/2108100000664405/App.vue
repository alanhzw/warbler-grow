 ...
 * @LastEditTime: 2021-11-10 14:13:19
 * @FilePath: \custom\src\pages\1000006644\99\2108100000664405\App.vue
-->
<template>
  <!-- 【a2至初】品牌新客专享价 -->
  <div class="a2-page"
    ...
    <!-- kv部分 -->
    <div class="kv">
      <img v-if="dayjs(new Date()).format('YYYY-MM-DD') > '2021-11-30'"
           src="./assets/new-background2.png" />
      <img v-else
...
<!--           src="./assets/something.png" />-->
    ...
    <div class="second-step">
      ...
      <div class="contact"
           @click="contact"></div>
      <img src="./assets/new-second.png" v-if="dayjs(new Date()).format('YYYY-MM-DD') > '2021-11-30'" />
      <img src="./assets/second.png" v-else/>
    </div>
    ...
    <!-- 立即购买 -->
    <div class="goto-goods-info"
         v-if="dayjs(new Date()).format('YYYY-MM-DD HH:mm:ss') > pageTime">
      <img src="./assets/goto-info.png" />
    </div>

    <!-- 商品列表 -->
    <div>
      <div class="goods-list"
           v-if="dayjs(new Date()).format('YYYY-MM-DD') > '2021-11-30'">
    ...
    <!-- 第四步 -->
    <div class="four-step">
      <img src="./assets/1000eCard2.png"
           v-if="dayjs(new Date()).format('YYYY-MM-DD HH:mm:ss') > pageTime">
      <img v-else
           src="./assets/1000eCard.png">
...
import newGoods1 from './assets/new-good-1.png';
import newGoods2 from './assets/new-good-2.png';
import newGoods3 from './assets/new-good-3.png';
import newGoods4 from './assets/new-good-4.png';
import new2Goods3 from './assets/new2-good-3.png';
import new2Goods4 from './assets/new2-good-4.png';
...
// 需要更换页面的时间
const pageTime = ref('2021-11-14 00:00:00');
