 ...
 * @FilePath:src\pages\1000376431\99\2110100037643101\components\ExposureGoods.vue
*/
<template>
  <!-- 曝光商品 -->
  <div class="skus" >
    <!-- 曝光商品列表 -->
    <div class="sku-list" v-if='skusList.length>0'>
      <!-- 单个曝光商品 -->
      <div class="sku-item"
        ...
        <img class="good-photo"
             :src="formatUrl(item.logo,baseUrl)"
             alt />
        <!-- 商品名称 -->
...
const formatUrl = (url:string, baseUrl:string) => (url.indexOf('http') > -1 ? url : `${baseUrl}${url}`);
