 ...
 * @Date: 2021/10/13
 * @Description: 【珀莱雅自营】 首购有礼
 * @FilePath:src\pages\1000376431\99\2110100037643101\App.vue
*/
<template>
...
const step = ref(1);
const dataInfo = '1、每个会员ID仅享1次，若已在店铺购买过正装商品无法使用；领取礼包的时间超过24小时&订单金额未满100元无法使用<br/>2、大促期不可使用（包括但不限于38、618、99、1111、1212等）<br/>3、同一ID在同一天内付款多笔订单仅计算一笔，无法在同一天同时享受首购礼及复购礼.<br/>4、首购权益隶属于珀莱雅品牌会员体系，珀莱雅自营店与珀莱雅官方旗舰店共享品牌权益，2家品牌店上述权益一个用户ID仅可领取1次"';
// 跳转至规则页面
const go2Step1 = () => {
  step.value = 1;
};
...
const go2Shop = () => {
  ...
  gotoShopPage(baseInfo.venderId);
};
