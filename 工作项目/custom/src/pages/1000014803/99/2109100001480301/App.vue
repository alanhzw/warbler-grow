<template>
  <div class="index">
    <div class="rule-button" @click="overlayRule = true"></div>
    <div class="myPrize-button" @click="overlayMyGift = true"></div>
    <div style="position: relative;top: -1.2rem;">
      <div v-for="item,index in giftList" :key="index" :class="'lottery-button lottery-button' + index">
        <img
      ...
      <div @click="changeprivacy(index)" v-for="item,index in privacy" :key="index" :class="'privacy-button privacy-button' + index">
        <img
      ...
      <div
        :class="'privacytext-button privacy-button' + index"
        @click="overlayPrivacy = true"
  ...
  <van-popup v-model:show="overlayPrivacy">
    <div class="privacy">
      ...
      <div class="rule-text">
        <p>
          请您务必仔细阅读并透彻理解隐私条款，该隐私条款解释了我们收集、使用、共享您提供给我们的信息的目的、方式和范围，以及我们如何保护您的信息。请在确认充分理解并同意本隐私条款后勾选“我已阅读并确认同意用户条款及隐私政策”。一旦您勾选同意，即表示您已充分理解并同意本隐私条款。
        </p>

        <p>
          - 您提供给我们的信息<br />
          为了领取奖品，您需要向我们提供您的姓名、手机号码、身份证号码和邮寄地址。所有上述个人信息均为您参与本次活动领取奖品所必需的个人信息，您明确同意并自愿向我们提供该等个人信息。如您不提供上述信息，我们将无法为您兑现奖品。
        </p>

        <p>
          - 儿童的个人信息<br />
          根据相关法律法规的规定，如果您是年龄不满14周岁的儿童，请确保您向我们提供有关您的姓名、手机号码、身份证号码和邮寄地址的行为已经征得您<span style="font-weight: bold;">的监护人的明确同意，并在您的监护人的帮助下向我们提供上述信息，以便我们为您兑现相关奖品。</span>
        </p>

        <p style="font-weight: bold;">
          如果您是不满14周岁儿童的监护人并向我们提供其相关信息，即表明您已代表该儿童同意我们按本隐私条款所述内容使用和处理该儿童的个人信息。
        </p>

        <p style="font-weight: bold;">
          如果我们发现收集的年龄不满14周岁的儿童的个人信息未获得其监护人同意，我们会设法尽快删除相关数据。
        </p>

        <p style="font-weight: bold;">
          我们会采取加密等技术措施存储儿童个人信息，确保信息安全。我们在中国境内存储儿童个人信息，不会超过实现其收集、使用目的所必需的期限。当我们的产品或服务发生停止运营的情形或您和儿童的个人信息存储期限届满时，我们将采取例如邮件、推送通知、公告等形式通知您和儿童，并在合理的期限内删除或匿名化处理儿童的个人信息。
        </p>
        ...
        <p>
          ...
          我们有可能因下列情况共享您的信息：<br />
          •
          为本次活动之目的，<span style="color: red;">我们会与北京环球影城指定单日门票奖品提供方及其关联公司、业务功能服务提供方共享您的信息，包括入园人的姓名、手机号、身份证号；</span><br />
          • 为本次活动之目的，向代表我们执行相关业务功能的服务提供商共享；<br />
          •
          脱敏信息：我们有权向第三方共享关于您的经汇总或去标识化处理过而无法重新识别的信息，以便他们更好地个性化您的体验并将更好的选择提供给您；<br />
          • 司法、执法机构等有权机关根据相关法律法规要求我们提供。
        </p>

        <p>
          - 保护您的信息<br />
          我们希望您能够放心地使用本活动页面服务。我们已使用符合业界标准的安全防护措施维护本活动页面服务的程序、技术和物理保障，以助于防止数据遭到未经授权的访问、丢失、滥用或泄露、更改或销毁。我们会采取一切合理可行的措施，保护您的个人信息，比如我们只允许有合理需要的员工可取得您的个人信息。这些保护措施的变化取决于我们收集和存储的信息的敏感性。请注意，并没有安全解决方案是绝对可靠的。
        </p>

        <p>
          请您务必仔细阅读并透彻理解本用户条款，特别是可能对您的权利作出一定限制的条款。请在确认充分理解并同意本隐私条款后勾选“我已阅读并确认同意用户条款及隐私政策”。一旦您勾选同意，即表示您已充分理解并同意本用户条款。
        </p>

        <p>
          •
          您知悉您于<span style="background-color: yellow;">2021年9月20日至2021年10月30日</span>期间，参与了2021年<span style="background-color: yellow;">【蒙牛的下单抽奖】</span>活动，从而中奖取得了<span style="background-color: yellow;">“北京环球度假区指定单日门票”或“【】实物礼品”</span>兑换资格。
        </p>

        <p>
          •
          您声明您是一名完全民事行为能力人；若您是一名限制民事行为能力人，您特此确认已经就兑现<span style="background-color: yellow;">“北京环球度假区指定单日门票”或“【】实物礼品”</span>兑换资格的行为取得您的法定监护人的同意。
        </p>

        <p>
          •
          您同意“北京环球度假区指定单日入园体验资格”的使用受限于届时有效的北京环球度假区入园规则及票务政策，北京环球度假区将会在法律允许的范围内对北京环球度假区指定单日入园体验资格使用规则给予必要的说明和解释。
        </p>

        <p>
          • 您同意 (a)
          在参加抽奖活动、接受、占有或使用“北京环球度假区指定单日入园体验资格”过程中（包括旅途中）发生的任何伤害和损失，北京国际度假区有限公司、其关联公司及其各自的管理人员、代理人和员工（共同称为“被免责方”）不承担任何责任；(b)
          被免责方不对任何由登入或下载与本抽奖活动相关的页面或软件而对任何计算机及移动设备造成或与其相关的伤害和损失负责；(c)
          认可被免责方未作出与“北京环球度假区指定单日入园体验资格”、在本次抽奖活动中由其他奖品提供方提供的奖品以及抽奖活动中的抽奖产品相关的任何承诺、保证或声明（包括任何与“北京环球度假区指定单日入园体验资格”一并提供的明示保证），无论是明示的亦或是默示的，无论是在事实上亦或是在法律上；进一步认可被免责方不对前述的任何承诺、保证或声明以任何形式负有任何法律责任；(d)
          被免责方不对任何远程通讯故障、网络故障、技术故障或计算机系统故障负责；不对错误传输与本抽奖活动或参与消费者相关信息负责；不对任何与此抽奖活动相关的抽奖材料或活动规则中出现的错误信息负责；不对任何人为或电子错误负责；不对就本抽奖活动或参与消费者相关信息产生的任何盗取、误导、捕获、延迟、丢失、损害或归还负责。<br />
        </p>
        <br>
        <br>
      </div>
    ...
    <div class="address">
      <div class="addess-formData">
        ...
        <input
          ...
          style="width: 82%;"
          onkeyup="value=value.replace(/[^\w\.\/]/ig,'');value=value.toUpperCase()"
          maxlength="18"
        />
      </div>
