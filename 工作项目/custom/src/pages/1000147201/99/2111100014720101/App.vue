...
* @Date: 2021/11/10
* @Description: 【swisse】会员下单送E卡-大贸
* @FilePath:src\pages\1000074146\99\2111100014720101\App.vue
*/
<template>
  ...
  <div class='content'>
    <div class='content_list' v-for='item in cardList' :key='item.id'>
      ...
      <div class='content-btn' @click='receiveGift(item)' :style='{background:(item.status=="1"?"":"#ccc"),boxShadow:(item.status=="1"?"":"none")}'>{{ item.status == '2' ? '已领取' : '立即领取' }}&gt;</div>
    </div>
  </div>
