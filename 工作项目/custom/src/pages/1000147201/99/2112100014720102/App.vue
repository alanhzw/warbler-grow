 ...
 * @FilePath:src\pages\1000147201\99\2112100014720102\App.vue
*/
<template>
...
const getActiveInfo = async () => {
  ...
  cardList.value = activityInfo.data?.giftVOS?.sort((a: any, b: any) => a.amount - b.amount);
  ...
  rules.value = activityInfo.data?.rule?.replace(/\n/g, '</br>');
};
