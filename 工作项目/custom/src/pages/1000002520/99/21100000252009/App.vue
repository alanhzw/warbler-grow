<template>
    ...
    <div>
        <img src="//img10.360buyimg.com/imgzone/jfs/t1/205061/29/2202/1249850/611f64b9Ee5a21636/234815b51b706114.png" class="process">
    </div>
...
const getECard = () => {
  cjwxRequest.post('/wyeth/card/main', {
...
<style lang='scss'>
  ...
  #app{
      background: url("//img10.360buyimg.com/imgzone/jfs/t1/191561/20/19099/850226/611f64b9Ec6938eb6/b0171edec4c03ea9.png") no-repeat #c0ed84;
      background-size: 100%;
  }
  .e-card{
      padding-top: 1.84rem;
