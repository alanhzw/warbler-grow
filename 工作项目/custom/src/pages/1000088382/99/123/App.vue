    ...
    <div class="state-area">
      <div class="state-btn">
        <div v-for="(item, index) in stateArr" :key="index">
          <img :src="item" :class="myLevel === index? '':'filter-gra'"/>
        </div>
      </div>
      <div v-if="myLevel === 0">
<!--        <img src="//img10.360buyimg.com/imgzone/jfs/t1/141747/34/25070/214701/61cbd61bE7feb17c7/b3e95f5c90e71d74.png">-->
      </div>
      <div v-if="myLevel === 1">
<!--        <img src="//img10.360buyimg.com/imgzone/jfs/t1/90088/15/20162/115860/61cbd61bE4d01860c/4723905806de1f2c.png">-->
      </div>
      <div v-if="myLevel === 2">
<!--        <img src="//img10.360buyimg.com/imgzone/jfs/t1/205499/14/20157/85838/61cbd61bE3269db69/d4e62aafcce7564e.png">-->
      </div>
    </div>
