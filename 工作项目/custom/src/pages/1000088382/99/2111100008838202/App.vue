 ...
 * @FilePath:src\pages\1000088382\99\2111100008838202\App.vue
*/
<template>
  ...
  <div class='title_box'>
    ...
    <div class='title'>
      ...
      <div class='claim_escription'>
        ...
        <p>活动结束后将在所有申请名单中随机选取<span class='key'>50</span>名用户赠送普仙小酒52度100ml，</p>
        <p>选取 <span class='key'>10</span>名用户赠送52度典藏500ml，选取<span class='key'>5</span>名用户赠送仙酿礼盒。奖品数量有限，火速参与吧！</p>
      </div>
    </div>
  </div>
  ...
  <!--  规则-->
  <Overlay :show='showDialog.isShowRule' @touchmove.self.prevent @click='showDialog.isShowRule = false' :lock-scroll='false'>
    <div class='wrapper' @touchmove.self.prevent >
      <div class='content'  @touchmove.self.prevent>
        <div class='rule_box'  @touchmove.self.prevent>
...
import { subForm, addressForm, getApplyStatue, getRules, goDetails, goMore, joinMember } from './hook/tools';
