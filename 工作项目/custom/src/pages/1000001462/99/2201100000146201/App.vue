    ...
    <div class="index-list">
      ...
      <div class="box box-wx">
        <div class="box-wx-text">
          每人限领取一次。获奖用户填写正确信息后，奖品以序列号方式发放，每个序列号仅可兑换一次，需在22年1月16日前完成兑换。若因信息未填、填写错误、自行分享、超期未兑等用户原因导致奖品作废，不予补发。
          <br/>领取流程：用户需更新手机微信至最新版本，打开发红包页面，前往“红包封面”-“添加红包封面”，输入有效领取序列号即可领取红包封面。详情请咨询客服。
        </div>
      </div>
      <div class="box">
        <img
