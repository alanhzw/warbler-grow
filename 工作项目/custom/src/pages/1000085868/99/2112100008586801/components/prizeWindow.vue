<template>
  <div class="prize-view">
    <div class="prizeView-area">
      <div v-if="myPrize.length > 0" style="padding-right: .11rem">
...
.prize-view{
  ...
  height: 7.93rem;
  position: relative;
  background: url("//img10.360buyimg.com/imgzone/jfs/t1/174739/16/21940/60727/61add135E55657f91/f8423e56735170bb.png") no-repeat;
  background-size: 100%;
  display: flex;
