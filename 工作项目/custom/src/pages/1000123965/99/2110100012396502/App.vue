<template>
  <div class="index">
    <img src="//img10.360buyimg.com/imgzone/jfs/t1/218563/9/41/1942009/61656669Ea24bf765/88748a51b63abbc3.png" alt="" class="index-img">
    ...
    <div class="sku-list">
      <div class="sku-list-button" v-for="item in skuLists" :key="item" @click="gotoSkuPage(String(item))"></div>
    </div>
    <div class="go-shop" @click="gotoShopPage(venderId)"></div>
  </div>
<!-- 规则弹窗 -->
...
import JD, { gotoSkuPage, gotoShopPage } from '@/utils/platforms';
...
const gotoOpenCard = () => {
  const returnUrl = encodeURIComponent(`https://${window.location.host}/m/1000123965/99/2110100012396502/?helpUuid=${inviterUuid}`);
  if (inviterUuid === '') {
...
const shareCMD = () => {
  JD.callShare({
    title: '帮我点一下，一起领豪礼',
    shareUrl: `https://${window.location.host}/m/1000123965/99/2110100012396502/?helpUuid=${myUuid.value}`,
  });
};
