<template>
  ...
  <div class="index">
    <div class="coupon-button" @click="getPrize(preizeList[0].name, preizeList[0].type, preizeList[0].value)"></div>
    <div class="gift-list">
      ...
      <div class="go-shop-page" @click="goPage"></div>
    </div>
  </div>
  <!-- 规则弹窗 -->
...
const preizeList: Ref<{name: string; value: string; totalRestNum: number; buttonStatus: number; type: number;}[]> = ref([]);
