 ...
 * @LastEditTime: 2021-05-30 02:19:25
 * @FilePath: \intelligent-overhaul-app\src\service\leader.apis.js
 */

export default {
  // 获取首页统计数据的接口
  getStatData: {
    url: "/mobile/api/groupLeaderHomePage/platform",
    method: "GET",
  },
  // 获取工单列表
  getOrders: {
    url: "/mobile/api/groupLeaderHomePage/list",
    method: "POST",
  },

  // 工单详情
  getOrderDetail: {
    url: "/mobile/api/groupLeaderHomePage/getTrustFormInfoById",
    method: "POST",
  },

  // 获取权限委托申请
  getPermissions: {
    url: "/mobile/api/groupLeaderHomePage/transferList",
    method: "GET",
  },
  // 工程委托单 - [自检]查询组员自检结果列表
  getSelfCheckById: {
  ...
  // 获取委托单位树形结构
  getTrustUnitTree: {
    url: "/mobile/api/groupLeaderHomePage/getTrustUnitTree",
    method: "GET",
  },
  // 获取施工单位树形结构
  getConstructionUnit: {
  ...
  // 作业长批量派单
  sendOrder: {
    url: "/mobile/api/orderSendToGroupConfirm/add",
    method: "POST",
  },
  ...
  // 退单审批 - 详情
  getOperationHistory: {
    url: "/mobile/api/returnOrder/getOperationHistory",
    method: "POST",
  },
  // 退单审批 - 同意/拒绝
  checkBackOrder: {
    url: "/mobile/api/returnOrder/getFormBackApproval",
    method: "POST",
  },
  // 获取工种
  getWorkCategory: {
