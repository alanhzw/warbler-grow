<!--
 * @Author: 一尾流莺
 * @Description:实例创建/复制页面
 * @Date: 2021-12-15 15:46:33
 * @LastEditTime: 2021-12-18 15:45:11
 * @FilePath: \nuxt-template-admin\pages\instance\create\[instanceId].vue
-->
<template>
...
// 新建还是复制
const isCreate = computed(() => instanceId.value === '000')
// 实例名称
