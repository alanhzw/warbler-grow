<template>
  <div class="box-style"
    ...
    <div class="drow-wheel-box">
      ...
      <div :style="options.backgroundInsideStyle"
           class="inside-bg"></div>
    ...
    <van-popup v-model="showBigImg">
      <div :class="{'show-big-img':!options.isDettol,'show-big-img-dettol':options.isDettol}">
        <img v-if='bigImgSrc'
             :src="bigImgSrc"
             class='big-img'>
        <div v-else
...
.box-style {
  ...
  .show-big-img-dettol {
    background: url('../../assets/show-big-img.png') no-repeat;
    width: 5rem;
    height: 10rem;
