 ...
 * @LastEditTime: 2021-12-02 10:55:31
 * @FilePath: \interact\src\tpls\QuotaDraw\durex\Editor.vue
-->
<template>
    ...
    <lz-form ref="elForm"
      ...
      <lz-form-item label="活动主图"
        ...
        <img v-else
             class="main-pic"
             :src="mainPic">
        <p class="tip">注：可上传宽度为750px，高度为800px的图片。图片格式为png、jpg。</p>
...
import mainPic from '../../../mobile/modules/durex0/assets/mainpic.png';
import CONST from '@/utils/constant';

export default {
  name: 'DettolQuotaDrawEditor',
  components: {
    JdImageSelector,
  },
  props: {
  ...
  methods: {
    ...
    imgValidator(width, height, size, type) {
      return new Promise((resolve, reject) => {
        if (width !== 750 || height !== 800) {
          reject('上传图片的尺寸为750*800px,请上传对应尺寸图片');
