 ...
 * @LastEditTime: 2021-03-08 16:33:00
 * @FilePath: \yunluhuodong\src\tpls\QuotaDraw\dettol\Editor.vue
-->
<template>
    ...
    <lz-form ref="elForm"
      ...
      <lz-form-item label="活动主图"
        ...
        <img v-else
             class="main-pic"
             :src="mainPic">
        <p class="tip">注：可上传宽度为750px，高度为450px的图片。图片格式为png、jpg。</p>
...
import mainPic from '@/assets/dettol-quota-draw-main.png';
    ...
    imgValidator(width, height, size, type) {
      return new Promise((resolve, reject) => {
        if (width !== 750 || height !== 450) {
          reject('上传图片的尺寸为750*450px,请上传对应尺寸图片');
