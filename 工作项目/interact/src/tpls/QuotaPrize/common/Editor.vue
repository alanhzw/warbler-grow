 ...
 * @LastEditTime: 2021-08-18 11:39:08
 * @FilePath: \interact\src\tpls\QuotaPrize\common\Editor.vue
-->
<template>
    ...
    <lz-form ref="elForm"
      ...
      <lz-form-item label="活动主图"
        ...
        <img v-else
             class="main-pic"
             :src="mainPic">
        <p class="tip">注：可上传宽度为750px，高度为850px的图片。图片格式为png、jpg。</p>
    ...
    imgValidator(width, height, size, type) {
      return new Promise((resolve, reject) => {
        if (width !== 750 || height !== 850) {
          reject('上传图片的尺寸为750*850px,请上传对应尺寸图片');
