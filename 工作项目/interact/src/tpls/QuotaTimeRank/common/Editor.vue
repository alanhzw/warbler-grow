 ...
 * @LastEditTime: 2021-08-17 16:29:28
 * @FilePath: \interact\src\tpls\QuotaTimeRank\common\Editor.vue
-->
<!--
 * @Description:
 * @Autor: hanzhiwei
 * @Date: 2021-02-03 09:49:40
 * @LastEditTime: 2021-02-05 14:32:54
 * @FilePath: \yunluhuodong\src\tpls\QuotaTimeRank\common\Editor.vue
-->

<template>
  <div class="quota-amount-rank-tpl-editor">
    <lz-form ref="elForm"
             label-width="200px">
      <lz-form-item label="活动主图"
        ...
        <img v-else
             class="main-pic"
             :src="mainPic">
        <p class="tip">注：可上传宽度为750px，高度为540px的图片。图片格式为png、jpg。
        </p>
...
export default {
  name: 'LzTplQuotaAmountRankEditor',
  components: {
    JdImageSelector,
  },
  props: {
