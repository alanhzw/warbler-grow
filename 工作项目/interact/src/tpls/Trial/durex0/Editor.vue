 ...
 * @LastEditTime: 2021-10-25 14:22:20
 * @FilePath: \interact\src\tpls\Trial\durex0\Editor.vue
-->

<template>
  <div class="trial-durex-page0-editor">
    <lz-form ref="elForm"
             label-width="200px">
...
import mainPic from '@/mobile/pages/trial/durex0/main-img.jpg';
