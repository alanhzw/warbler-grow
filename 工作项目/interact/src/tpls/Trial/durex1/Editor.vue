 ...
 * @Description:
 * @Autor: hanzhiwei
 * @Date: 2021-01-28 09:01:16
 * @LastEditTime: 2021-10-26 15:36:47
 * @FilePath: \interact\src\tpls\Trial\durex1\Editor.vue
-->

<template>
  <div class="trial-durex-page1-editor">
    <lz-form ref="elForm"
             label-width="200px">
...
import mainPic from '@/mobile/pages/trial/durex1/main-img-01.png';
